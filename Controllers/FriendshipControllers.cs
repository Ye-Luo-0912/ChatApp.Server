...
using Core.Models.Friend.Request;
    ...
    IFriendshipService friendshipService) : ControllerBase
{
    ...
    /// <returns></returns>
    [HttpGet("all")]
    public IAsyncEnumerable<FriendDto> GetAllFriends()
    {
    ...
    public IAsyncEnumerable<FriendRequestDto> GetIncomingRequests()
    {
    ...
    public IAsyncEnumerable<FriendRequestDto> GetOutgoingRequests()
    {
        return friendshipService.GetRequestsAsync<FriendRequestDto>(
            GetCurrentUserId(),
            r => new FriendRequestDto
    ...
    [HttpGet("blocked")]
    public IAsyncEnumerable<BlockedUserDto> GetBlockedUsers()
    {
    ...
    [HttpGet("search")]
    public IAsyncEnumerable<FriendSearchResultDto> SearchFriends(
