...
public interface IAuthService
{
    ...
    /// 注册新用户。
    /// </summary>
    Task<UserRegistrationResult> RegisterAsync(string? username, string email, string password);

    /// <summary>
    /// 使用刷新令牌换取新的令牌对。
    /// </summary>
    Task<TokenPairResult> RefreshLoginAsync(long account, string refreshToken);
