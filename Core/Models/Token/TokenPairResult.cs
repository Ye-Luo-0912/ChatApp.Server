...
public struct TokenPairResult()
{
    ...
    public static TokenPairResult Success(string? accessToken, string? refreshToken, string? deviceCredential = null)
        => new() { IsSuccess = true, AccessToken = accessToken, RefreshToken = refreshToken, DeviceCredential = deviceCredential };
